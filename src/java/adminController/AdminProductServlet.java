...
//        processRequest(request, response);
        ArrayList<ProductDTO> listProduct = (new ProductDAO()).getAllProductDTO();
        request.setAttribute("listProduct", listProduct);
        if (request.getParameter("productID") != null) {
            
            (new ProductDAO()).updateProductStatus(Integer.parseInt(request.getParameter("productID")), Integer.parseInt(request.getParameter("status")));
