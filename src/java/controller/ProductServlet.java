...
public class ProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
//        response.getWriter().print(request.getParameter("index"));
        int categoryID = Integer.parseInt(request.getParameter("categoryID"));
        
           ArrayList<Products> list = (new ProductDAO()).getTop9ProductLastest(categoryID, Integer.parseInt(request.getParameter("index")));
//        ArrayList<Products> listDress = (new ProductDAO()).getTop9ProductLastest(Integer.parseInt(request.getParameter("index")));
            int size = 9;
