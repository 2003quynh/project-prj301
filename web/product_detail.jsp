            ...
            <div class="container">
                    ...
                    <div class="left-columm col-lg-5 col-md-5">
                        ...
                        <div class="tab-pane active" id="product-01" role="tabpanel" aria-labelledby="product-tab-01">
                            <div class="single-img img-full">
                                <a href="${product.image}"><img src="${product.image}" class="img-fluid zoomImg" alt=""></a>
                            </div>
                        </div>
                        <c:if test="${listImage.size()-1}>=0">
                            <c:forEach begin="0" end="${listImage.size()-1}" var="i">
                                <div class="tab-pane" id="product-0${i+2}" role="tabpanel" aria-labelledby="product-tab-0${i+2}">
                                    <div class="single-img">
                                        <a href="${listImage.get(i).image}"><img src="${listImage.get(i).image}" class="img-fluid" alt=""></a>
                                    </div>
                                </div>
                            </c:forEach>
                        </c:if>
                ...
                <div class="right-columm col-lg-7 col-md-7">
                    <div class="product-information">
                        <h4 class="product-title text-capitalize float-left w-100">${product.name}</h4>
                        ...
                        <div class="product-variants float-left w-100">
                            ...
                            <div class="color-option d-flex align-items-center">
                                <h5>color :</h5>
                                <select class="color-categories" name="color">
                        ...
                        <button type="submit" name="button" class="btn btn-primary btn-cart m-0" data-target="#cart-pop" data-toggle="modal" value="add"><i class="material-icons">shopping_cart</i> Add To Cart</button><br>
