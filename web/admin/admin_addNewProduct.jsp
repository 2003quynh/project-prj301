                ...
                <div class="container mt-5">
                    ...
                    <form action="admin-addProduct" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="descriptionSummary" name="descriptionSummary" rows="3" required></textarea>
                        </div>
                        ...
                        <div class="form-group" id="sizeColorQuantity">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="btn btn-danger" onclick="removeGroup(this)" style="display: none;">Close</button>
                            </div>
                        </div>

                        <button type="button" class="btn btn-primary" id="moreFields">More</button>
